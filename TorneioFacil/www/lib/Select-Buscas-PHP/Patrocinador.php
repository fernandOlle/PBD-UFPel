...
<?php
    ...
    $query_resultado = "SELECT cpf, nome, contribuicao from patrocinador  ORDER BY contribuicao";
    ...
    if( ($resultado) AND ($resultado->rowCount() != 0) ){
        ...
        extract($row_users);
        echo "CPF: " . $cpf . "<br>Nome do Patrocinador: " . $nome . "<br>Contribuição: " . $contribuicao . "<br> <hr>";
    }}else{
