...
<head>
    ...
    <title>Listar Integrante</title>
</head>
<body>
<a href="../../index.php">Voltar para o inicio</a>
    <h1>Listar Integrante</h1>

<?php
    $query_usuarios = "SELECT cpf, nome, email, id_time FROM integrante";
    ...
    if( ($resultado_usuarios) AND ($resultado_usuarios->rowCount() != 0 ) ){
        while($row_usuários = $resultado_usuarios->fetch( PDO:: FETCH_ASSOC )){
            ...
            echo "<br>CPF: " . $cpf . "<br>Nome: " . $nome . "<br>Email:" . $email . "<br>ID do time que pertence:" . $id_time . "<br> <hr>";
        }
